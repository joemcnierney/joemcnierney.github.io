...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Dashboard | Mondo - Client Dashboard</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Client Dashboard for Current & Future Mondo Solutions Clients" name="description" />
        <meta content="Mondo Solutions" name="Joe McNierney" />
        <!-- App favicon -->
            ...
            <div class="main-content">
                        ...
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <li class="breadcrumb-item active">Welcome to Mondo Client Dashboard</li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        ...
                                        <div class="row">
                                                <div class="col-6">
                                                    <h5>Welcome Back !</h5>
                                                    <p class="text-muted">Mondo Portal</p>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                2020 © Mondo Solutions, LLC.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-right d-none d-sm-block">
                                    Crafted with <i class="mdi mdi-heart text-danger"></i> by Mondo
                                </div>
                            </div>
                        </div>
                    </div>
